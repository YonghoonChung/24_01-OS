// Our teammate Minyoung Song made a critical comment on my code.
// I modified as his comment.
// I changed the line main function.
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <ctype.h>
...
int main()
{
	...
	*/
	...
	// New Code - I change the location of mutex destroy.
	while(!kbhit() || getch() != 27)
		usleep(10000);
	cont = FALSE;
